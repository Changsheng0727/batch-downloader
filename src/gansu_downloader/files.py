...
def copy_raster_family(src_tif: Path, dest_tif: Path) -> None:
    ...
    src_base = src_tif.with_suffix("")
    dest_base = dest_tif.with_suffix("")
    for src_side, dest_side in [
        (src_base.with_suffix(".tfw"), dest_base.with_suffix(".tfw")),
        (src_base.with_suffix(".prj"), dest_base.with_suffix(".prj")),
